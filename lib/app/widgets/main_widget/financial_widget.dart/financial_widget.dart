...
class FinancialWidget {
  static Widget summaryPage(SummaryModel? summary, Function getData,
      bool isLoadingCharge, Function onTapCharge) {
    return summary == null
        ? const SizedBox()
            ...
            child: Column(
              children: [
                ...
                financialCard(
                    ...
                    appText.charge, () async {
                  // charge

                  onTapCharge();
                }, AppAssets.walletSvg, green77(), isLoading: isLoadingCharge),
                space(35),
                Padding(
                  padding: padding(),
                  child: Column(
                    ...
                    children: [
                      ...
                      (summary.history?.isEmpty ?? true)
                          ? Container(
                              ...
                              child: emptyState(
                                  AppAssets.noBalanceEmptyStateSvg,
                                  appText.noBalance,
                                  appText.noBadgesDesc))
                          : Column(
                              children: List.generate(
                                  summary.history?.length ?? 0, (index) {
                                return historyItem(
                                    summary.history?[index].description ?? '',
                                    timeStampToDateHour(
                                        (summary.history?[index].createdAt ??
                                                0) *
                                            1000),
                                    CurrencyUtils.calculator(
                                        summary.history?[index].amount),
                                    summary.history?[index].balanceType ==
                                        'addition' // addition | deduction
                                    );
                              }),
                            )
                    ],
  ...
  static Widget offlinePaymentPage(List<OfflinePaymentModel> offlinePayments) {
    return (offlinePayments.isEmpty)
        ? Center(
            child: emptyState(AppAssets.offlinePaymentEmptyStateSvg,
                appText.noOfflinePayments, appText.noOfflinePaymentsDesc))
        : Padding(
            padding: padding(),
      ...
      child: Column(
        children: [
          ...
          financialCard(
              ...
              (payout?.currentPayout?.withdrawableAmount ?? 0) == 0.0
                  ? ''
                  : appText.requestPayout, () async {
            // request
                  ...
                  children: [
                    ...
                    (payout?.payouts?.isEmpty ?? true)
                        ? Container(
                            ...
                            margin: const EdgeInsets.only(top: 60),
                            child: emptyState(AppAssets.noBalanceEmptyStateSvg,
                                appText.noPayout, appText.noPayoutDesc))
                        : Column(
                            children: [
                              space(12),
                              ...List.generate(payout?.payouts?.length ?? 0,
                                  (index) {
                                return payoutItem(
                                  payout?.payouts?[index].accountBankName
                                          ?.getTitle() ??
                                      '',
                                  timeStampToDateHour(
                                      (payout?.payouts?[index].createdAt ?? 0) *
                                          1000),
                                  CurrencyUtils.calculator(double.parse(payout
                  ...
                  children: [
                    Container(
                      ...
                      child: SvgPicture.asset(
                        AppAssets.videoSvg,
                        colorFilter: ColorFilter.mode(green50, BlendMode.srcIn),
                        width: 20,
                      ),
                    ),
                    space(8),
                  ...
                  children: [
                    Container(
                      ...
                      child: SvgPicture.asset(
                        ...
                        colorFilter: ColorFilter.mode(blueFE, BlendMode.srcIn),
                        width: 20,
                      ),
                    ),
                    space(8),
                    ...
                    Container(
                      ...
                      child: SvgPicture.asset(
                        ...
                        colorFilter: ColorFilter.mode(
                            yellow4C.withOpacity(.6), BlendMode.srcIn),
                        width: 20,
                      ),
                    ),
                    space(8),
                    Text(
                      ((data?.meetingsCount ?? 0) + (data?.webinarsCount ?? 0))
                          .toString(),
                      style: style14Bold(),
                    ),
                    space(4),
            ...
            children: [
              ...
              (data?.sales?.isEmpty ?? true)
                  ? Container(
                      alignment: Alignment.center,
                      margin: const EdgeInsets.only(top: 60),
                      child: emptyState(AppAssets.salesEmptyStateSvg,
                          appText.noSales, appText.noSalesDesc))
                  : Column(
                      children: [
                        ...List.generate(data?.sales?.length ?? 0, (index) {
                          return userCard(
                              ...
                              timeStampToDateHour(
                                  (data.sales![index].createdAt ?? 0) * 1000),
                              CurrencyUtils.calculator(double.tryParse(
                                      data.sales![index].amount ?? '0') ??
                                  0),
  ...
  static Widget financialCard(String amount, String subtitle, String buttonText,
      Function onTapButton, String icon, Color iconBgColor,
      {bool isBg = false, Function? onTapBox, bool isLoading = false}) {
  ...
  static Widget historyItem(
      String title, String date, String amount, bool isUp) {
    return Container(
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${isUp ? '+' : '-'}$amount',
                    style:
                        style16Bold().copyWith(color: isUp ? green77() : red49),
                  )
                ],
              )
            ],
            ...
            Center(
              child: button(
                  onTap: () async {
                    ...
                    bool res = await FinancialService.requestPayout(
