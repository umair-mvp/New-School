...
import '../../../../pages/main_page/home_page/certificates_page/certificates_page.dart';
...
import '../../../../services/user_service/rewards_service.dart';
...
class SingleCourseWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: padding(),
            constraints: viewMore ? null : BoxConstraints(maxHeight: 250),
          ...
          if (courseData.description!.length > 200) ...{
            if (viewMore) ...{
              space(5),
            } else ...{
              Stack(
  ...
  static Widget contentPage(
      ...
      {List<CourseModel> bundleCourses = const []}) {
    return ModernExpandableContentPage(
          ...
          Row(
            ...
            children: [
              userProfile(review.user!,
                  showRate: true, customRate: review.rate),
