...
import '../../../pages/main_page/home_page/notification_page.dart';
import '../../../pages/main_page/home_page/search_page/suggested_search_page.dart';
...
class HomeWidget {
  static Widget homeAppBar(
      ...
      String name,
      screeSize) {
    // Always start with collapsed search
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child:
                                          SvgPicture.asset(AppAssets.menuSvg),
                                    ),
                                  ),
                                  ...
                                  // basket, notification and search icon
                                  Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      // Search Icon with rotation animation
                                      AnimatedRotation(
                                        turns: isSearchExpanded ? 0.125 : 0,
                                        duration:
  ...
  // Expanded Search Bar with fade and slide animation
  static Widget _buildExpandedSearchBar(
    TextEditingController searchController,
    FocusNode searchNode,
  ) {
  ...
  // Collapsed space with minimal height
  static Widget _buildCollapsedSpace() {
