...
class AuthenticationService {
  static Future google(String email, String token, String name) async {
    try {
      ...
      showSnackBar(
        ErrorEnum.error,
        null,
        desc: 'Network Error: Please check your connection.',
      );
      return false;
    }
  }
  ...
  static Future apple(String? email, String id, String? name) async {
    try {
      String url = '${Constants.baseUrl}apple/callback';

      print('Apple Sign-In - email: $email, name: $name, id: $id');
