...
class _UserProfilePageState extends State<UserProfilePage>
  ...
  int? userId; // Add this to store the user ID
  ...
  getData(int id) async {
    ...
    print("Profile result: ${profile != null ? 'SUCCESS' : 'NULL'}");
    if (profile != null) {
      print("Profile name: ${profile!.fullName}");
      print("Profile role: ${profile!.roleName}");
    }
  ...
  Widget build(BuildContext context) {
    return directionality(
      ...
      appBar: appbar(
          title:
              isLoading ? 'Loading...' : profile?.fullName ?? 'User Profile'),
      body: isLoading
          ? loading()
          : profile == null
              ? Center(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                                child: button(
                                    onTap: () {
                                      if (locator<UserProvider>().profile !=
                                          null) {
                                        profile?.authUserIsFollower =
                                            !(profile?.authUserIsFollower ??
                                                false);
                                        ProvidersService.follow(
                                            profile!.id!,
                                            (profile?.authUserIsFollower ??
                                                false));
