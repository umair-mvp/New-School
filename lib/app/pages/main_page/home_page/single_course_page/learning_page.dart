...
import '../../../../services/user_service/forum_service.dart';
...
class _LearningPageState extends State<LearningPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      courseData =
          ModalRoute.of(context)!.settings.arguments as SingleCourseModel;

      Future.wait([getContentData(), getNoticesData(), getForumData()])
          .then((value) {
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: button(
                                  onTap: () async {
                                    bool? res = await LearningWidget
                                        .forumNewQuestionSheet(courseData!.id!);
                            ...
                            if (forumData?.forums?.isNotEmpty ?? false) ...{
                              ...
                              button(
                                  onTap: () {
                                    LearningWidget.forumSearchSheet(
                                        courseData!.id!);
                                  },
                                  width: 52,
                                  height: 52,
