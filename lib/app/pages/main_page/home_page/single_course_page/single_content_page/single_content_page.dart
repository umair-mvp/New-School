...
import '../../../../../services/user_service/personal_note_service.dart';
...
Future getData() async {
  ...
  try {
    ...
    print('Content Link: ${content?.link}');
    print('Single Content Data: $singleContentData');
    
    if (singleContentData == null) {
      print('singleContentData is NULL - API call failed');
      return;
    }
    
    // Debug individual fields
    print('Title: ${singleContentData?.title}');
    print('File: ${singleContentData?.file}');
    print('Storage: ${singleContentData?.storage}');
    print('File Type: ${singleContentData?.fileType}');
    print('Attachments Count: ${singleContentData?.attachmentsCount}');
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      singleContentData?.title ?? 'No Title Available',
                      style: style16Bold(),
                    ),
