...
class _SubscriptionPageState extends State<SubscriptionPage>
  ...
  late StreamSubscription _sub = StreamController().stream.listen((_) {});
  ...
  Future<void> initUniLinks() async {
    try {
      // Uncomment and use your uni_links implementation
