...
import '../app/models/forum_answer_model.dart';
import '../app/models/forum_model.dart';
...
import '../app/services/user_service/forum_service.dart';
    ...
    child: Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // image
            fadeInImage(courseData.image ?? '', getSize().width, 315),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      padding: padding(horizontal: 8, vertical: 3),
                      decoration: BoxDecoration(
                        color: green4B,
                      ...
                      child: Text(
                        ...
                        style: style12Regular().copyWith(color: greyFA),
                      ),
                    ),
                  ),
...
//         borderRadius: borderRadius(radius: 26),
//         boxShadow: [
//           BoxShadow(
...
//             ),
//             Padding(
//               padding: padding(horizontal: 22, vertical: 22),
//               child: Column(
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   Row(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: CustomPaint(
                painter: _MeshGradientPainter(color),
              ),
            ),
            // Glossy overlay
            Positioned(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var gradient in gradients) {
      paint.shader = RadialGradient(
        ...
        center: gradient['center'] as Offset,
        radius: gradient['radius'] as double,
      ));
      canvas.drawRect(
...
Widget modernVerticalChapterItem(
    Color color, String icon, String title, String subTitle, Function onTap,
    {double width = 24,
    double height = 24,
