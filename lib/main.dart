...
import 'package:newschool/app/pages/main_page/home_page/payment_status_page/payment_status_page.dart';
...
import 'app/pages/main_page/home_page/dashboard_page/reward_point_page.dart';
import 'app/pages/main_page/home_page/meetings_page/meeting_details_page.dart';
import 'app/pages/main_page/home_page/single_course_page/single_content_page/pdf_viewer_page.dart';
import 'app/pages/main_page/home_page/single_course_page/single_content_page/web_view_page.dart';
import 'app/pages/offline_page/internet_connection_page.dart';
import 'app/pages/offline_page/offline_list_course_page.dart';
import 'app/pages/offline_page/offline_single_content_page.dart';
import 'app/pages/offline_page/offline_single_course_page.dart';
import 'app/providers/drawer_provider.dart';
import 'common/data/app_language.dart';
import 'common/database/model/course_model_db.dart';
...
import 'app/pages/main_page/home_page/terms_and_rules_page/terms_and_rules_page.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          TermsAndRulesPage.pageName: (context) => const TermsAndRulesPage(),
          // offline pages...
